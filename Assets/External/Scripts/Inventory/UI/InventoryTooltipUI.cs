...
public class InventoryTooltipUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [Header("References")]
    ...
    public void ShowTooltip(ItemInstance item)
    {
        ...
        if (nameText != null) nameText.text = def.itemName;
        ...
        if (weightText != null) weightText.text = $"{def.weight:F1} kg";
        if (valueText != null) valueText.text = $"{def.baseValue} G";
        ...
        {
            if (freshnessText != null) freshnessText.text = "";
